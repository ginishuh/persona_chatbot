...
- **신음/의성어 혼합:** 대사 안에 자연스럽게 신음을 1~2회 섞습니다(예: "하아…", "읏", "흣", "응"). 문장 중간/끝에 가볍게 배치하고, 같은 표현을 과도하게 반복하지 않도록 변주합니다. 신음만 단독 줄로 쓰지 않습니다.
...
- **신음/의성어 혼합(강화):** 거의 모든 대사에 신음/감탄을 1회 이상 섞고, 길이가 짧은 신음을 문장 리듬에 맞춰 배치합니다(예: "하앙…", "읏…", "후읏", "하아"). 같은 표기를 과도하게 반복하지 말고, 상황·감정에 맞춰 음절·길이를 다양화합니다.
