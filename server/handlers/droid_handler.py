    ...
    async def start(self, system_prompt=None):
        ...
        try:
            args = [
                ...
                "--model", "custom:glm-4.6"  # GLM-4.6 모델 (Factory 무료)
            ]
            ...
            logger.info(f"Droid process started (cwd: {self.chatbot_workspace})")
        ...
        try:
            ...
            async def read_stderr():
                while True:
                    ...
                    if not line:
                        break
                    logger.debug(f"Droid stderr: {line.decode('utf-8').strip()}")
            ...
            try:
                ...
                while True:
                    try:
                        ...
                        logger.error("Timeout waiting for Droid response")
                        break
